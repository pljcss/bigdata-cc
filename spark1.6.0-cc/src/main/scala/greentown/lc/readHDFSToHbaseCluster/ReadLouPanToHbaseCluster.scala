package greentown.lc.readHDFSToHbaseCluster
...
/**
  * Created by saicao on 2017/4/19.
  */
object ReadLouPanToHbaseCluster {
  // 将手机号封装在ArrayBuffer中
  ...
  def main(args: Array[String]): Unit = {
    parseLouPanToHbaseCluster(args(0))
  }
  ...
  /**
    ...
    * @param date
    */
  def parseLouPanToHbaseCluster(date: String)={
    /**
